...
const AUTH_STARTUP_TIMEOUT_MS = 3500
...
// leave the startup splash instead of waiting forever. This does not sign the
// user out, clear storage, or stop the normal auth-state listener from
// restoring a delayed session afterward.
