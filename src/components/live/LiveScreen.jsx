...
export default function LiveScreen({
  ...
  /*
   * One-PWA law: the shared media hook owns media health and foreground checks.
   * LiveScreen must not tear down/re-attach a healthy MediaStream on focus,
   * pageshow, or visibilitychange. That reset caused WebKit to re-present the
   * camera as a centered portrait layer after returning to the installed PWA.
   */
