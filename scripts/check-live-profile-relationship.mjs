...
assert.match(profileSheet, /Gifts Sent[\s\S]*FameTaps/, 'In-Live profiles must lead with Gifts Sent and FameTaps.')
...
console.log('Live profile relationship contract passed: Gifts/FameTaps lead, Followers/Following/Friends stay three-across, and follow states remain wired.')
