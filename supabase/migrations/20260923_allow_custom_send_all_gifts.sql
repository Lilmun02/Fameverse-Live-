-- Fameverse gift-send parity: every approved gift supports Custom Send.
-- Preserve wallet authority, self-gift restriction, active-room checks, and quantity bounds.
-- The separate 5,000-coin accidental-send protection is intentionally NOT implemented here;
-- its exact product law is still pending owner completion.
